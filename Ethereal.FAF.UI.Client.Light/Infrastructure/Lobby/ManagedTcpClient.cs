...
namespace beta.Models
{
    ...
    public abstract class ManagedTcpClient
    {
        ...
        private async void RunLoopStep()
        {
            ...
            while (bytesAvailable > 0 && c.Connected)
            {
                ...
                if (nextByte[0] == 10)
                {
                    await ProcessDataAsync(StringEncoder.GetString(cacheSB.ToArray()));
                    cacheSB.Clear();
                }
        ...
        protected abstract Task ProcessDataAsync(string json);
