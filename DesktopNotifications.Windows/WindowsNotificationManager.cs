...
namespace DesktopNotifications.Windows
{
    public class WindowsNotificationManager : INotificationManager
    {
        ...
        public Task ShowNotification(Notification notification, DateTimeOffset? expirationTime = null, bool isXmlBody = false,
            Uri? hero = null, Uri? inline = null, Uri? appLogo = null)
        {
            ...
            var xmlContent = GenerateXml(notification, isXmlBody, hero, inline, appLogo);
        ...
        {
            return ShowNotification(notification, expirationTime, false);
        }
        ...
        {
            return ScheduleNotification(notification, deliveryTime, expirationTime);
        }
        public Task ScheduleNotification(
            Notification notification,
            DateTimeOffset deliveryTime,
            bool isXmlBody = false,
            DateTimeOffset? expirationTime = null)
        {
            ...
            var xmlContent = GenerateXml(notification, isXmlBody);
        ...
        private static XmlDocument GenerateXml(Notification notification, bool isXmlBody = false,
            Uri? hero = null, Uri? inline = null, Uri? appLogo = null)
        {
#if NETSTANDARD
            ...
            if (hero != null) builder.AddHeroImage(hero);
            if (inline != null) builder.AddInlineImage(inline);
            if (appLogo != null) builder.AddAppLogoOverride(appLogo);
            ...
            //    Status = "Downloading..."
            //});
            //builder.AddAudio(new Uri("C:\\Users\\Eternal\\Downloads\\DesktopNotifications-master\\DesktopNotifications-master\\WpfApp1\\water.mp3"));
            //builder.AddInlineImage(new Uri("https://learn.microsoft.com/ru-RU/windows/apps/design/shell/tiles-and-notifications/images/send-toast-02.png"));
            //builder.AddAppLogoOverride(new Uri("https://learn.microsoft.com/ru-RU/windows/apps/design/shell/tiles-and-notifications/images/toast-notification.png"), ToastGenericAppLogoCrop.Circle);
