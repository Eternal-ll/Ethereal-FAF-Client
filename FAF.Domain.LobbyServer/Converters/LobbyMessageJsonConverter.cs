	...
	public class LobbyMessageJsonConverter : JsonConverter<ServerMessage>
	{
        ...
        public LobbyMessageJsonConverter()
        {
			_commandConverters = new Dictionary<ServerCommand, Func<JsonDocument, ServerMessage>>()
			{
				...
				{ ServerCommand.JoinGame, (json) => JsonSerializer.Deserialize<IceUniversalData>(json) }, 
				{ ServerCommand.HostGame, (json) => JsonSerializer.Deserialize<IceUniversalData>(json) }, 
				{ ServerCommand.ConnectToPeer, (json) => JsonSerializer.Deserialize<IceUniversalData>(json) }, 
				{ ServerCommand.DisconnectFromPeer, (json) => JsonSerializer.Deserialize<IceUniversalData>(json) }, 
				{ ServerCommand.IceMsg, (json) => JsonSerializer.Deserialize<IceUniversalData>(json) }, 
